...
public class TurnoJpaController implements Serializable {
    ...
    public void create(Turno turno) {
        ...
        try {
            ...
            if (pacien != null) {
                pacien.getListaTurnosPaciente().add(turno);
    ...
    public void edit(Turno turno) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (pacienOld != null && !pacienOld.equals(pacienNew)) {
                pacienOld.getListaTurnosPaciente().remove(turno);
                pacienOld = em.merge(pacienOld);
            }
            if (pacienNew != null && !pacienNew.equals(pacienOld)) {
                pacienNew.getListaTurnosPaciente().add(turno);
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            Paciente pacien = turno.getPacien();
            if (pacien != null) {
                pacien.getListaTurnosPaciente().remove(turno);
                pacien = em.merge(pacien);
            }
            em.remove(turno);
            em.getTransaction().commit();
